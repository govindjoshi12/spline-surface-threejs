...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function fa(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:es(),fragmentShader:`
...
`].filter(oi).join(`
`)),o=qr(o),o=Sa(o,t),o=Ea(o,t),a=qr(a),a=Sa(a,t),a=Ea(a,t),o=ya(o),a=ya(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(b=`#version 300 es
